...
const Navbar = (props: sideNavtype) => {
  ...
  return (
    <nav className="bg-[#080808] backdrop-blur-md bg-opacity-30 flex justify-between fixed top-0 left-0 right-0 h-16 border-b border-gray-200 items-center z-10">
      <div className="">
        <div className="left-nav flex gap-2 items-center">
          <div
            onClick={props?.toggleDisplaynav}
            className={`mx-2 flex md:hidden h-9 w-9 rounded-full hover:bg-[hsl(216,8%,12%)] active:bg-[#182947] content-center cursor-pointer relative group ${
          ...
          <div className="ml:2 md:ml-4 relative fle group w-auto">
            <Link href="/" className="text-white text-2xl  md:text-3xl">
              AfriXpace
            </Link>
        ...
        <div className="middle-navbar mx-2 max-w-[500px] md:max-w-[700px] flex flex-1 ">
          <input
        ...
        <div className="right-navbar flex gap-2 whitespace-nowrap mr-4">
          ...
          <div className="flex items-center ">
            <div className="flex items-center ">
              ...
              <div>
                <Link href="/signup">
                  <button className="text-white p-1 ml-2 bg-gray-300 rounded-md hover:bg-gray-500">
                    Sign up
                  </button>
                </Link>
              </div>
