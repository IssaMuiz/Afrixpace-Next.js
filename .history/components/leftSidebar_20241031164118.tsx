...
const LeftSidebar = (props: Sidenavtype) => {
  ...
  return (
    <section
      className={`w-72 p-10 pl-12 backdrop-blur-3xl flex-col border-r bg-[#313131] flex bg-opacity-80 mt-16  fixed z-0 h-full left-0 overflow-scroll top-0 scrollbar transform transition-tranform ease-in-out duration-300 ${
