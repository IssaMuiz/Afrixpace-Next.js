  ...
  return (
    <nav className="left-navbar bg-[#080808] backdrop-blur-md bg-opacity-30 flex justify-between fixed top-0 left-0 right-0 h-16 border-b border-gray-200 items-center z-10">
      <div
        ...
        className={`ml-2 flex md:hidden h-9 w-9 rounded-full hover:bg-[hsl(216,8%,12%)] active:bg-[#182947] content-center cursor-pointer relative group ${
      ...
      <div className="right-navbar flex gap-2 whitespace-nowrap ">
