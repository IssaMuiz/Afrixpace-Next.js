...
const LeftSidebar = (props: Sidenavtype) => {
  ...
  return (
    <aside>
      <div
        className={`w-72 lg:flex p-10 pl-12 backdrop-blur-3xl flex-col border-r bg-[#313131] bg-opacity-80 mt-16 fixed z-0 h-full left-0 overflow-scroll top-0 scrollbar transform transition-transform duration-300 -translate-x-full lg:translate-x-0 ${
