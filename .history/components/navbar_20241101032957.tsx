      ...
      <div className="flex justify-between items-center p-3">
        <div className="left-nav flex gap-1 items-center">
          <div
            ...
            className={`mx-2 flex xl:hidden h-9 w-9 rounded-full hover:bg-[hsl(216,8%,12%)] active:bg-[#182947] content-center cursor-pointer relative group ${
          ...
          <div className="md:ml-4 relative group w-auto">
