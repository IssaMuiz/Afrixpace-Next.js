...
const LeftSidebar = (props: Sidenavtype) => {
  ...
  return (
    <aside>
      <div
        className={`w-72 lg:flex p-10 pl-12 backdrop-blur-3xl flex-col border-r bg-[#313131] bg-opacity-80 mt-16 fixed z-0 h-full left-0 overflow-scroll top-0 scrollbar transform transition-transform duration-300 -translate-x-full xl:translate-x-0 ${
          props?.displaySidenav ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {categories.map((category) => (
          <div key={category.id}>
            <div className="mb-8 border-b transition-all ease-in-out duration-500  transform">
              <div
              ...
              >
                ...
                <div>
                  <Image
                    width={10}
                    height={10}
                    className={`ml-10 flex items-end transform transition-tranform ease-in-out duration-300 cursor-pointer invert ${
              ...
              <div>
                {category.expanded && (
                  <div className="border-l ml-8 transform transition-tranform ease-in-out duration-300">
